...
<!-- 로딩중 -->
	...
	<form action="/base/findPwAction.do" method="post">
		<div id="findMemform">
			...
			<div class="findpwd">
				...
				<a href="/base/findPw.do">비밀번호 재설정</a>
				<a href="/base/findId.do">아이디 찾기</a>
				<button class="defaultBtn loginBtn" type="submit" id="pwResetBtn">비밀번호 재설정</button>
			</div>		
			
			
			<p>아직 회원이 아니신가요? <a href="/base/joinForm.do">회원가입하기</a></p>
