...
<body>
	...
	<form id="signUp" method="post" action="/base/joinAction.do">
		<h3 class="contents">회원가입</h3>
		<div class="myForm-group">
			<div class="form-inline">
				<label for="MEMBER_ID" style="display: block;">아이디 *</label> 
				<input type="text"
					class="form-control form-inline" id="MEMBER_ID" name="MEMBER_ID"
					placeholder="아이디를 입력하세요">
				<button type="button" class="btn btn-default" id="id_check_btn">중복확인</button>
				<div id="id_check"></div>
			</div>
...
/* 		if(!getCheck.test($("#MEMBER_ID").val())){
		...
		$.ajax({
			url : 'base/selectIdCheck.do?mem_userid='+ mem_userid,
			type : 'get',
			dataType : 'json',
	...
	/* $("#MEMBER_EMAIL").on('keyup', function() {
		...
		$.ajax({
			url : 'base/selectEmailCheck.do?user_email='+ user_email,
			type : 'get',
			success : function(data) {
			console.log("1 = 중복o / 0 = 중복x : " + data);
			if (data > 0) {
