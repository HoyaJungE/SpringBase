...
.text-dark { color: #343a40!important; }
	...
	<div id="loginform">
		...
		<form action="/base/loginAction.do" method="POST" id="frm">
			...
			<a href="/base/findPw.do">비밀번호
					재설정</a>
			<a href="/base/findId.do">아이디
					찾기</a>
			<button type="submit" class="defaultBtn loginBtn" id="login">로그인</button>
		</form>
			<p>
			아직 회원이 아니신가요? <a href="/base/joinForm.do">회원가입하기</a>
...
var naverLogin = new naver.LoginWithNaverId({
	...
	callbackUrl : "http://localhost:8080/base/loginCallback.do",
	isPopup : true,
	loginButton : {
		color : "green",
		type : 1,
