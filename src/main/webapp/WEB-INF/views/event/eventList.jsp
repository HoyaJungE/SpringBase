	...
	var str = "";
		$.each(data.list, function(key, value){
			str += "<tr>"
					...
					+ "<td style='letter-spacing: 1px; text-align: center; vertical-align: middle;'><img alt='image' width='*' height='50px' style='margin: 5px; border: 1px solid lightgray; border-radius: 10px;' src='/base/file/" + value.EVENT_THUMBNAIL + "'></td>"
