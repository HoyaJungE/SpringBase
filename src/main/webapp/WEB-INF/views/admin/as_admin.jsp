			...
			<c:choose>
				<c:when test="${fn:length(as_admin_list) > 0}">
					...
					<c:choose>
						...
						<li class="active"><a href="/base/as_admin.do?as=1">신규요청</a></li>
						</c:when>
						<c:otherwise>
						<li><a href="/base/as_admin.do?as=1">신규요청</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AS_STATE eq '2' }">
						<li class="active"><a href="/base/as_admin.do?as=2">처리중</a></li>
						</c:when>
						<c:otherwise>
						<li><a href="/base/as_admin.do?as=2">처리중</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AS_STATE eq '3' }">
						<li class="active"><a href="/base/as_admin.do?as=3">처리완료</a></li>
						</c:when>
						<c:otherwise>
						<li><a href="/base/as_admin.do?as=3">처리완료</a></li>
						</c:otherwise>
					</c:choose>
					</c:forEach>
				</c:when>
