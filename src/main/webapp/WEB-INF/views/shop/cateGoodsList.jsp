...
<div align="right" style="margin-right:410px">
	<table>
		<tr>
			...
			<td class="font1"><a href="/base/shop/goodsList/${category}/NewItem.do">신상품순</a></td> <td>|</td>
			<td class="font1"><a href="/base/shop/goodsList/${category}/favorite.do">인기상품순</a></td> <td>|</td>
			<td class="font1"><a href="/base/shop/goodsList/${category}/low.do">낮은가격순</a></td> <td>|</td>
			<td class="font1"><a href="/base/shop/goodsList/${category}/high.do">높은가격순</a></td> 
		</tr>
	</table>
</div>
