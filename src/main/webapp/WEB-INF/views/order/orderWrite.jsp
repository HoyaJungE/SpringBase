...
<script src="/base/js/common.js" charset="utf-8"></script>
...
function fn_price(){ 
	...
	var hap_buy = Number('<c:out value="${f.ORDER_TOTAL_ORDER_PRICE.value}"/>');  //총 주문금액
	var u_p = '<c:out value="${f.POINT_TOTAL.value}"/>'; //보유포인트  '
	var o_point = Number('<c:out value="${f.ORDER_USE_POINT.value}"/>'); //사용할포인트
...
<body onload="fn_allPrice()">
    <div class="container">
      ...
      <form name="orderWrite" id="orderWrite" method="post" action="/base/order/orderPay.do">
      	<%-- <!-- goods정보 -->
            ...
            <colgroup>
              ...
              <tbody>
					...
					<c:forEach items="${list }" var="row" varStatus="status">
						...
						<tr>
                  			<td>
                  				<img src='/base/file/${row.GOODS_THUMBNAIL }' width="70px" height="70px">
                  			</td>
							<td>
				  				<a href="/base/shop/goodsDetail.do?IDX=${row.GOODS_NO }">${row.GOODS_NAME }</a> <br>
          ...
          <div class="table-responsive">
            ...
            <div style="text-align:center">
            	<input type="checkbox" name="orderChk" id="orderChk">
          		...
          		<br><br>
          		<input type="button" name="all_order" value="장바구니" onClick="location.href='/base/basket/basketList.do'">
