					...
					<input type="hidden" name="goods_no" value="${row.GOODS_NO }">
						<tr>
							...
							<td style="text-align:left">
				  				<a href="/base/shop/goodsDetail.do?IDX=${row.GOODS_NO }">${row.GOODS_NAME }</a>
				  			</td>
				  			<td style="text-align:center">
                  				${row.GOODS_SELL_PRICE } 원
                  			</td>
							<td style="text-align:center">
                  				<input type="button" name="goodsDetail" value="구매" onclick="location.href='/base/shop/goodsDetail.do?IDX=${row.GOODS_NO }'"><br>
