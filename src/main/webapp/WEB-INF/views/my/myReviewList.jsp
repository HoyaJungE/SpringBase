		...
		function fn_selectReviewListCallback(data){
			...
			if (total == 0) {
				...
				$.each(data.list, function(key, value) {
									...
									if(REVIEW_IMG == null){
									str += " <tr class='show1'> "
										+  "<td><img src='/base/file/"+value.GOODS_THUMBNAIL+"' width='70px' height='70px'></td>"
										+  " <td><a href='/base/shop/goodsDetail.do?IDX="+value.GOODS_NO +"' name='title'>" + value.GOODS_NAME + "</a></td>"
