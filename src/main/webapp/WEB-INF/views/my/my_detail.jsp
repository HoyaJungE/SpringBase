...
function order_list() {
	...
	location.href="/base/order_admin_a.do?os="+os;
	return;	
}
					...
					<%-- ${detail_sub } --%>			
						<tr>
							<td style="text-align:center">
                  				<img src='/base/file/${detail_sub.GOODS_THUMBNAIL }' width="70px" height="70px">
                  			</td>
							<td>
								<a href="/base/shop/goodsDetail.do?IDX=${detail_sub.GOODS_NO }">${detail_sub.GOODS_NAME }</a> <br> 
