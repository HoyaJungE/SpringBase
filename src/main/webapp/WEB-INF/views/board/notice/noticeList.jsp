...
<body>
   ...
   <div class="pagemid">
      <div class="wrapper3">
         <ul class="flex-menu">
            <li><a href="http://localhost:8080/base/faq/openFaqList.do">FAQ</a></li>
            <li><a
               href="http://localhost:8080/base/notice/openNoticeList.do">공지사항</a></li>
            <li><a href="http://localhost:8080/base/qna/openQnaList.do">QNA</a></li>
         </ul>
         <br>
         <div class="bar"></div>
      </div>
