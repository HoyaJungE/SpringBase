			...
			<ul class="nav" id="side-menu">
				...
				<li><a href="#" style="background: #F8F8F8;">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/myOrderList.do">- 주문/배송 내역</a></li>
						<li><a href="/base/myAsList.do">- 교환/환불/AS 내역</a></li>
						<li><a href="/base/my/myPointList.do">- 포인트</a></li>
						<li><a href="/base/my/myCouponList.do">- 할인쿠폰</a></li>
						<li><a href="/base/my/myLikeList.do">- 찜 상품</a></li>
				...
				<a href="#" style="background: #F8F8F8;">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/my/openMyReview.do">- 나의 상품평</a></li>
						<li><a href="/base/my/openMyGoodsQna.do">- 나의 Q&A글</a></li>						
					</ul>
				</li>
				...
				<a href="#" style="background: #F8F8F8;">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/my/memberModify.do">- 회원정보수정</a></li>
						<li><a href="/base/my/memberDelete.do">- 회원 탈퇴</a></li>						
					</ul>
				</li>	
