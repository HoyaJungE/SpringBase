	...
	<div class="navbar-default sidebar" role="navigation" style="width: 250px;">
		...
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				<li><a href="/base/main.do" style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
						<b class="fa fa-dashboard fa-fw">쇼핑몰로 이동</b> 
				</a></li>
					
				<li><a href="/base/order_admin_a.do"
					style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
						<b class="fa fa-dashboard fa-fw">주문배송관리</b> 
				</a></li>
				
				<li><a href="/base/as_admin.do" style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
				...
				<li><a href="#" style="background: #e7e7e7;">
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="/base/shop/openGoodsWrite.do">- 상품등록</a></li>
						<!-- <li><a href="">- 할인 적용</a></li> -->
					</ul></li>

				
				<li><a href="/base/member_admin.do"
					style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
						<b class="fa fa-dashboard fa-fw">회원관리</b> 
				</a></li>

				<li><a href="/base/adminReport.do"
					style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
				...
				<li class="active"><a href="#" style="background: #e7e7e7;">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/">- 공지사항</a></li>
						<li><a href="/base/">- FAQ</a></li>
						<li><a href="/base/">- 구매후기</a></li>
						<li><a href="/base/">- 상품Q&A</a></li>
					</ul></li>
				...
				<li class="active">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/adminCouponList.do">- 쿠폰목록/수정</a></li>
						<li><a href="/base/adminCouponWriteForm.do">- 쿠폰등록</a></li>
					</ul>
				</li>
				<!-- e 쿠폰 추가 2020.06.25 -->
				...
				<li class="active">
					...
					<ul class="nav nav-second-level">
						<li><a href="/base/adminEventList.do">- 이벤트목록/수정</a></li>
						<li><a href="/base/adminEventWriteForm.do">- 이벤트등록</a></li>
					</ul>
				</li>
				<!-- e 이벤트 추가 2020.06.30 -->
